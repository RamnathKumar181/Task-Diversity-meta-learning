#!/bin/bash
#SBATCH --job-name=test_metaoptnet_meta_dataset
#SBATCH --output=../logs/test_metaoptnet_meta_dataset_%a.out
#SBATCH --error=../logs/test_metaoptnet_meta_dataset_%a.err
#SBATCH --gres=gpu:2
