...
cd .. && python -m src.main --exp_name reptile_omniglot_no_diversity_task_sampling --train --model reptile --runs 1 ./data --task_sampler no_diversity_task --dataset omniglot --num-ways 5 --num-shots 1 --use-cuda --step-size 0.4 --batch-size 32 --num-workers 8 --num-epochs 600 --output-folder ./config/reptile_omniglot_no_diversity_task_sampling/
