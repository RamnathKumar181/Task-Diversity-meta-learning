...
cd .. && python -m src.main --train --model protonet --runs 1 ./data --meta-lr 0.001 --task_sampler no_diversity_batch --dataset omniglot --num-ways 5 --num-shots 1 --use-cuda --step-size 0.4 --batch-size 32 --num-workers 8 --num-epochs 600 --output-folder ./config/protonet_omniglot_no_diversity_batch_sampling/
